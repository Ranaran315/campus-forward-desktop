  ...
  return (
    <div className="input-dialog-overlay">
      <div className="input-dialog">
        ...
        {label && <label className="input-dialog-label" htmlFor="dialog-input">{label}</label>}
        <InputField
          id="dialog-input"
          name="dialogInput"
          type="text"
        ...
        <div className="input-dialog-actions">
          ...
          <Button theme="primary" onClick={handleConfirm} disabled={isConfirming} /*isLoading={isConfirming}*/>
