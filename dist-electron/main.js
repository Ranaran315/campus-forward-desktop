...
function createLoginWindow() {
  ...
  if (VITE_DEV_SERVER_URL) {
    loginWin.loadURL(`${VITE_DEV_SERVER_URL}/#/login`);
  ...
  loginWin.on("ready-to-show", () => {
    loginWin == null ? void 0 : loginWin.show();
  });
  loginWin.on("closed", () => {
...
app$1.whenReady().then(() => {
  ...
  electronApp.setAppUserModelId("com.yourcompany.yourappname");
  app$1.on("browser-window-created", (_, window) => {
    optimizer.watchWindowShortcuts(window);
  });
  ipcMain$1.on("login-success", (_, token) => {
  ...
  ipcMain$1.on("minimize-login-window", () => {
    loginWin == null ? void 0 : loginWin.minimize();
  });
  ipcMain$1.on("close-login-window", () => {
    loginWin == null ? void 0 : loginWin.close();
  });
  ipcMain$1.on("minimize-window", () => {
    console.log("Main: Minimizing main window");
    mainWin == null ? void 0 : mainWin.minimize();
  });
  ipcMain$1.on("maximize-window", () => {
    if (mainWin == null ? void 0 : mainWin.isMaximized()) {
      console.log("Main: Unmaximizing main window");
      mainWin == null ? void 0 : mainWin.unmaximize();
    } else {
      console.log("Main: Maximizing main window");
      mainWin == null ? void 0 : mainWin.maximize();
    }
  });
